...
namespace Nintenlord.Event_Assembler.Core.Code.Language
{
  public static class FE6CodeLanguage
  {
    ...
    public static readonly Tuple<string, List<Priority>>[][] PointerList = new Tuple<string, List<Priority>>[7][]{ new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("TurnBasedEvents", EACodeLanguage.MainPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("CharacterBasedEvents", EACodeLanguage.MainPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("LocationBasedEvents", EACodeLanguage.MainPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("MiscBasedEvents", EACodeLanguage.MainPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("EnemyUnits", EACodeLanguage.UnitPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("AllyUnits", EACodeLanguage.UnitPriorities) }, new Tuple<string, List<Priority>>[1]{ new Tuple<string, List<Priority>>("EndingScene", EACodeLanguage.NormalPriorities) } };
  }
}
